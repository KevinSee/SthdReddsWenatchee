...
ps_mort_wen %>%
  ...
  kable(digits = 3,
        booktabs = T,
        caption = "Wenatchee prespawn mortality estimates. Includes estimates (standard error) of escapement, spawners, rate of prespawn mortality, and standard error of this rate, separated by origin.") %>%
  kable_styling(bootstrap_options = c("striped", "hover"),
                latex_options = "striped")
```
